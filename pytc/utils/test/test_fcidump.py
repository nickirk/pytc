...
from pytc.utils.fcidump import write_fcidump, read_fcidump
...
class TestFCIDump(unittest.TestCase):
    ...
    def test_fcidump(self):
        ...
        n_elec_xtc = self.mol.nelec[0]
        
        write_fcidump(self.filename, h1e_xtc, h2e_xtc, ecore_xtc, n_orb_xtc, n_elec_xtc)
        n_orb_fcidump, n_elec_fcidump, ecore_fcidump, h1e_fcidump, h2e_fcidump = read_fcidump(self.filename)
