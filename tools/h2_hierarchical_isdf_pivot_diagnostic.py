#!/usr/bin/env python
"""Compare screened hierarchical ISDF pivots against global Cholesky on H2.

This is a CPU-only, small-grid diagnostic.  It is intentionally not an ISDF
production mode and does not write an ISDF cache or run CCSD.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--max-grid", type=int, default=128)
...
def main() -> None:
    args = parse_args()
    if min(args.max_grid, args.rank, args.leaf_size, args.local_rank) < 1:
